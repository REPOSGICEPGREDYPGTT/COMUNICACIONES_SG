classdef tcpip_cliente_pc1
    ...
    methods
        ...
        function l=lectura_datos_190(obj)
            l=fread(obj.obj_tcpip,95,'uint16');
        end
        ...
        function l=lectura_datos_2048(obj)
            l=fread(obj.obj_tcpip,1024,'uint16');
        end
        
        % Operación de lectura server_1 - S: 1024B - C:nB
        function l=lectura_datos_4096(obj)
            l=fread(obj.obj_tcpip,2048,'uint16');
        end
        ...
        % Organización de los datos de lectura - S: 160B - C:6B
        function [CONF1,K1,ALFA1,B1,PS1,TMS1,TINS1,ESC1,CONF2,K2,ALFA2,B2,PS2,TMS2,TINS2,ESC2,CONF3,K3,ALFA3,B3,PS3,TMS3,TINS3,ESC3,CONF4,K4,ALFA4,B4,PS4,TMS4,TINS4,ESC4,CONF5,K5,ALFA5,B5,PS5,TMS5,TINS5,ESC5,ADICIONAL]=arreglo_datos_s170_c6(obj)
            ...
            xxx=(obj.dato_lectura(81:85));
            ADICIONAL=double(string(char(xxx.')));
        end
        
        % Organización de los datos de lectura - S: 190B - C:6B
        function [CONF1,K1,ALFA1,B1,PS1,TMS1,TINS1,ESC1,CONF2,K2,ALFA2,B2,PS2,TMS2,TINS2,ESC2,CONF3,K3,ALFA3,B3,PS3,TMS3,TINS3,ESC3,CONF4,K4,ALFA4,B4,PS4,TMS4,TINS4,ESC4,CONF5,K5,ALFA5,B5,PS5,TMS5,TINS5,ESC5,ADICIONAL]=arreglo_datos_s190_c6(obj)
            CONF1=obj.dato_lectura(1)+(obj.dato_lectura(2))/1e4;
            K1=obj.dato_lectura(3)+(obj.dato_lectura(4))/1e4;
            ALFA1=obj.dato_lectura(5)+(obj.dato_lectura(6))/1e4;
            B1=obj.dato_lectura(7)+(obj.dato_lectura(8))/1e4;
