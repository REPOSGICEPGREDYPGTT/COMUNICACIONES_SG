...
if client_1.buffer_in==170
    client_1.dato_lectura=lectura_datos_170(client_1);
    if isempty(client_1.dato_lectura)==0
        [CONF1,K1,ALFA1,B1,PS1,TMS1,TINS1,ESC1,CONF2,K2,ALFA2,B2,PS2,TMS2,TINS2,ESC2,CONF3,K3,ALFA3,B3,PS3,TMS3,TINS3,ESC3,CONF4,K4,ALFA4,B4,PS4,TMS4,TINS4,ESC4,CONF5,K5,ALFA5,B5,PS5,TMS5,TINS5,ESC5,ADICIONAL]=arreglo_datos_s170_c6(client_1);
        ...
        % Grabación en BD
        grabar_datos_llegada_170(client_1,'BD_datos_llegada170.txt')
        
        % Actualización de la configuración enviada en simulink
        [puerto,e]=duracion2(client_1,'BD_datos_salida6.txt','BD_datos_llegada170.txt');
...
if client_1.buffer_in==190
    ...
    if isempty(client_1.dato_lectura)==0
        [CONF1,K1,ALFA1,B1,PS1,TMS1,TINS1,ESC1,CONF2,K2,ALFA2,B2,PS2,TMS2,TINS2,ESC2,CONF3,K3,ALFA3,B3,PS3,TMS3,TINS3,ESC3,CONF4,K4,ALFA4,B4,PS4,TMS4,TINS4,ESC4,CONF5,K5,ALFA5,B5,PS5,TMS5,TINS5,ESC5,ADICIONAL]=arreglo_datos_s190_c6(client_1);
        client_1.dato_lectura=[CONF1,K1,ALFA1,B1,PS1,TMS1,TINS1,ESC1,CONF2,K2,ALFA2,B2,PS2,TMS2,TINS2,ESC2,CONF3,K3,ALFA3,B3,PS3,TMS3,TINS3,ESC3,CONF4,K4,ALFA4,B4,PS4,TMS4,TINS4,ESC4,CONF5,K5,ALFA5,B5,PS5,TMS5,TINS5,ESC5,ADICIONAL];             
        
        % Grabación en BD
        grabar_datos_llegada_170(client_1,'BD_datos_llegada190.txt')
...
if client_1.buffer_in==256
    ...
    if isempty(client_1.dato_lectura)==0
        ...
        % Grabación en BD
        grabar_datos_llegada_170(client_1,'BD_datos_llegada256.txt')
...
if client_1.buffer_in==512
    ...
    if isempty(client_1.dato_lectura)==0
        ...
        % Grabación en BD
        grabar_datos_llegada_170(client_1,'BD_datos_llegada512.txt')
...
if client_1.buffer_in==1024
    ...
    if isempty(client_1.dato_lectura)==0
        ...
        % Grabación en BD
        grabar_datos_llegada_170(client_1,'BD_datos_llegada1024.txt')
...
if client_1.buffer_in==2048
    ...
    if isempty(client_1.dato_lectura)==0
        ...
        % Grabación en BD
        grabar_datos_llegada_170(client_1,'BD_datos_llegada2048.txt')
...
if client_1.buffer_in==4096
    ...
    if isempty(client_1.dato_lectura)==0
        ...
        % Grabación en BD
        grabar_datos_llegada_170(client_1,'BD_datos_llegada4096.txt')
